...
export const contractAddressJob = "0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9";   //job contract address
export const contractABIJob = [
	{
  "_format": "hh-sol-artifact-1",
  "contractName": "JobManagement",
  "sourceName": "contracts/JobManagement.sol",
  "abi": [
    {
      "inputs": [
        {
